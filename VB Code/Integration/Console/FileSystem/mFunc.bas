...
Declare Function dcWaitForSingleObject Lib "Kernel32" Alias "WaitForSingleObject" (ByVal hHandle As Long, ByVal dwMilliseconds As Long) As Long
    ...
    If Len(cmdString) > 0 Then
        ...
        If l1 = 1 Then
            Do
                ...
                vCmd = Split(tmpCmd, ":")
                If TB_Runtime.UboundEx(vCmd) = 1 Then
                    param.Key = vCmd(0)
                    param.Value = vCmd(1)
                    params.Add param
                End If
